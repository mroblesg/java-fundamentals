...
class TypeAnnotationsExample<@What(description = "Generic data type") T> {
    // Use a type annotation on a constructor.
    public @Unique TypeAnnotationsExample() {}
    ...
    public int f(@TypeAnno TypeAnnotationsExample<T> this, int x) {
        return 10;
    }
    ...
    public static void myMeth(int i) {
        ...
        TypeAnnotationsExample<@TypeAnno Integer> ob =
                new TypeAnnotationsExample<@TypeAnno Integer>();
        // Use a type annotation with new.
        @Unique TypeAnnotationsExample<Integer> ob2 = new @Unique TypeAnnotationsExample<Integer>();
    ...
    class SomeClass extends @TypeAnno TypeAnnotationsExample<Boolean> {}
}